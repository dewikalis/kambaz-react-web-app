...
This is the third paragraph. Wrap each paragraph with the paragraph tag to tell browsers to render the gaps.
  ...
  <ol id="wd-pancakes">
    ...
    <li>Serve and enjoy!</li>
        ...
        <ol id="wd-mapo-tofu">
    <li>Chop ginger and garlic.</li>
    <li>Cut tofu into small cubes</li>
    <li>Fry ginger and garlic in pan with oil.</li>
    <li>Add mined meat and seasonings.</li>
    <li>Stir until cooked and add mapo tofu sauce.</li>
    <li>Add tofu cubes.</li>
    <li>Add water and let simmer for a few minutes.</li>
    <li>Make slurry and add to pan.</li>
    <li>Serve and enjoy!</li>
  </ol>
